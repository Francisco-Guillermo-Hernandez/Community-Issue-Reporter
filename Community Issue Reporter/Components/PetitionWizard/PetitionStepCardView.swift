...
struct PetitionStepCardView <Content: View>: View {
    let step: PetitionStep
    let currentStep: PetitionStep
...
#Preview {
    PetitionStepCardView(step: .details, currentStep: .details, metadata: petitionStepsMetadata["Details"]) {
